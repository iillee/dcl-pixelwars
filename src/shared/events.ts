 ...
 *
 * Naming convention: `domain:event` — `round:reset`, `team:assigned`, etc.
...
export type Events = {
	...
	// UTC round boundary crossed. Server has already zeroed its paint CRDT
	// state and rolled the new seed. Subscribers: HUD (banner), paint (clear),
